...
namespace SnapEat
{
    public partial class SA_Registration : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connStr))
            {
                ...
                string query = @"INSERT INTO [User] ([dtCreated], [uName], [uGender], [uProfile], [uEmail], [uPassword], [uContact], [uBirthday], [uRole]) 
                                 VALUES (@dtCreated, @uName, @uGender, @uProfile, @uEmail, @uPassword, @uContact, @uBirthday, @uRole)";
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@uRole", uRole.SelectedValue);
        ...
        private void ClearFields()
        {
            ...
            uRole.ClearSelection();

            ScriptManager.RegisterStartupScript(this, this.GetType(), "clearFile",
                "document.getElementById('" + uProfile.ClientID + "').value = null;", true);
